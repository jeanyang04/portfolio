          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>Continuous Learning: Technology evolves rapidly, and I believe in lifelong learning to stay at the forefront.</li>
                <li>Problem Solving: I approach challenges with a methodical and creative mindset, aiming for elegant and efficient solutions.</li>
                <li>Collaboration: Teamwork and open communication are key to successful projects.</li>
                <li>User-Centric Design: Building intuitive and impactful experiences for users is paramount.</li>
              </ul>
            </CardContent>
          </Card>
        </div>
